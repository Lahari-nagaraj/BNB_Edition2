...
const anomalySchema = new mongoose.Schema({
  ...
  type: { 
    type: String, 
    enum: ["budget_overrun", "unusual_spending", "duplicate_transaction", "suspicious_activity", "vendor_anomaly"],
    required: true 
  },
  severity: { 
    type: String, 
  ...
  detectedBy: { type: String, enum: ["system", "ai", "user"], default: "system" },
  status: { 
    type: String, 
